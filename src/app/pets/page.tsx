...
const pets: Pet[] = [
  ...
  { id: 13, name: 'Giant Leaf-Tailed Gecko', image: 'https://assets.k12path.com/MystikCafe/pets/Giant%20Leaf-Tailed%20Gecko.jpg', species: 'Uroplatus fimbriatus', origin: 'Madagascar', habitat: 'Primary rainforests, on tree trunks', size: '9-12 inches', temperature: '70-75°F', humidity: '70-80%', diet: 'Insectivore', lifespan: '8-10 years', funFact: 'Masters of camouflage - they look exactly like tree bark!', description: 'An incredible gecko with a flat, leaf-shaped tail and cryptic coloration that makes them nearly invisible against tree bark.' },
