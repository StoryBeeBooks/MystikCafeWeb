...
const pets: Pet[] = [
  ...
  { id: 19, name: 'Yellow Quince Monitor', image: 'https://assets.k12path.com/MystikCafe/pets/Yellow%20Quince%20Monitor.jpg', species: 'Varanus melinus', origin: 'Indonesia', habitat: 'Tropical forests, mangroves', size: '3-4 feet', temperature: '80-85°F (basking: 95-100°F)', humidity: '70-80%', diet: 'Carnivore - insects, eggs, small animals', lifespan: '15-20 years', funFact: 'One of the most beautifully colored monitor lizards!', description: 'A striking yellow and black monitor known for their intelligence and curious personality.' },
  ...
  { id: 25, name: 'Milk Frog', image: 'https://assets.k12path.com/MystikCafe/pets/milk%20frog.jpg', species: 'Trachycephalus resinifictrix', origin: 'Amazon Rainforest', habitat: 'Tropical rainforest canopy, near water', size: '2.5-4 inches', temperature: '75-82°F', humidity: '70-80%', diet: 'Insectivore', lifespan: '8-10 years', funFact: 'Secretes a milky substance when stressed - hence the name!', description: 'A striking frog with beautiful blue and brown banded pattern.' },
  { id: 26, name: 'Axolotl', image: 'https://assets.k12path.com/MystikCafe/pets/Axolotl.jpg', species: 'Ambystoma mexicanum', origin: 'Lake Xochimilco, Mexico', habitat: 'Freshwater lakes, canals (aquatic)', size: '9-12 inches', temperature: '60-68°F (cool water)', humidity: 'N/A (fully aquatic)', diet: 'Carnivore - worms, small fish, insects', lifespan: '10-15 years', funFact: 'Can regenerate entire limbs, heart, and even parts of their brain!', description: 'The "walking fish" that\'s actually a salamander - critically endangered in the wild.' },
