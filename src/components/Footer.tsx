    ...
    <footer className="relative">
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          {/* CTA */}
          <p className="text-white/80 text-lg mb-2 tracking-wider uppercase">Join Us</p>
          <h2 className="text-4xl md:text-5xl font-bold text-white mb-6">
            Explorers of the Wild
          </h2>
          <Link 
            href="/book"
            className="inline-block bg-[#8FCE00] hover:bg-[#7ab800] text-[#1a3b0e] font-bold py-4 px-10 rounded-full text-lg shadow-lg hover:-translate-y-1 transition-all"
          >
            BOOK YOUR ADVENTURE
          </Link>
        </div>
      ...
      {/* Main Footer Content */}
      <div className="bg-[#1a3b0e] text-white py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center md:text-left">
            ...
            <div className="flex flex-col items-center md:items-start">
              <h3 className="text-[#8FCE00] font-semibold mb-4 text-sm uppercase tracking-wider">Follow Us</h3>
              <div className="flex gap-4">
                <a 
                  href="https://www.instagram.com/mystikcafe/" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="w-10 h-10 bg-white/10 hover:bg-[#8FCE00] rounded-full flex items-center justify-center transition-colors"
            ...
            <div className="flex flex-col items-center">
              <h3 className="text-[#8FCE00] font-semibold mb-4 text-sm uppercase tracking-wider">Quick Links</h3>
            ...
            <div className="flex flex-col items-center md:items-end text-sm">
              <h3 className="text-[#8FCE00] font-semibold mb-4 text-sm uppercase tracking-wider">Contact Us</h3>
              <address className="not-italic text-white/80 space-y-1 text-center md:text-right">
