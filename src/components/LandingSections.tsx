        ...
        <div style={galleryStyles.bottomTagline}>
          ...
          <div style={galleryStyles.socialRow}>
            <a 
              ...
              style={{ ...galleryStyles.socialIcon, display: 'block', color: '#E4405F' }}
            >
            ...
            <a 
              ...
              style={{ ...galleryStyles.socialIcon, display: 'block', color: '#000000' }}
            >
              <svg style={{ width: '100%', height: '100%' }} fill="currentColor" viewBox="0 0 24 24">
            ...
            <a 
              ...
              style={{ ...galleryStyles.socialIcon, display: 'block', color: '#1877F2' }}
            >
              <svg style={{ width: '100%', height: '100%' }} fill="currentColor" viewBox="0 0 24 24">
