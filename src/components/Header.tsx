      ...
      <header style={styles.header}>
        <div style={styles.container}>
          ...
          <div style={styles.rightSection} className="desktop-nav">
            ...
            >
              <svg style={styles.icon} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1} d="M12 19c-4 0-7-2-7-5 0-2 1.5-3.5 3-4.5.5-3 2-5.5 4-5.5s3.5 2.5 4 5.5c1.5 1 3 2.5 3 4.5 0 3-3 5-7 5z" />
